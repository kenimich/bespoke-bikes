        ...
        public DbContextOptions<BespokeBikesContext> CreateDbContextOptions() {
            ...
            optionsBuilder.UseSeeding((context, _) => {
                ...
                context.Inventories.AddRange(
                    new Inventory { ProductId = bike_mtn.Id, Quantity = 5, PurchasePrice = 950m, PurchaseDate = new DateTime(2025, 7, 1) },
                    new Inventory { ProductId = bike_road.Id, Quantity = 5, PurchasePrice = 1200m, PurchaseDate = new DateTime(2025, 10, 1)}
                );
                context.SaveChanges();
